...
public class WordTypeCounter {
	public static void main(String[] args) throws Exception
	{
		if(args.length > 1)
		{
			...
			// la implementacion SimpleSet que acompaÒa esta tarea.
			...
			if(wordFile.isFile() && textFile.isFile()) {
				...
				while(line!=null)
				{
					wordParts = line.split("\\.");  // lo que esta entre comillas es una expresiÛn regular.
				...
				while(line!=null)
				{
					// Separar todas las palabras en la lÌnea.
					textParts = line.split("[^\\w-]+"); // utilizar de separador cualquier caracter que no sea una letra, n˙mero o guiÛn.
